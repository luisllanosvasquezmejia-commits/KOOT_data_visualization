...
with col1:
    st.markdown('<h1 style="color:#ffffff ; font-size:70px; font-weight:500; background-color:rgba(2,2,2,0.7); padding:2px 10px; display:inline-block; border-radius:10px;">KIND OF ON THAT</h1>',
    ...
    st.markdown('<h1 style="color:#ffffff ; font-size:20px; font-weight:500">"kind on onn that" -- Dr-William Stoll',  unsafe_allow_html=True)
